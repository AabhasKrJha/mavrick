...
export function HeroSection(){
    return(
        <div className="h-[90vh] flex flex-col items-center justify-center mt-20 md:mt-0 gap-3 md:gap-0">
            ...
            <div className={cn(crimsonPro.className ,"flex flex-col gap-1 md:gap-6 items-center justify-center")}>
                ...
                <span className="text-xl lg:text-3xl italic text-blue-200 mb-96">Since Nov 19, 2017</span>
